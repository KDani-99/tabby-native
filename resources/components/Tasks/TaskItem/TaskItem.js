...
export default class TaskItem extends React.Component
{
    ...
    {
        this.setState({selectedTheme:props.selectedTheme,selected:props.completed});
    }
    select()
    {
    ...
    render()
    {
        return( 
            <Animated.View style={[{transform:[{scale:this.state.mainProgress.interpolate({
                ...
                <Ripple onLayout={this.onLayout} style={style.container} rippleColor={this.state.selectedTheme} onPress={this.select} delayLongPress={1500} onLongPress={this.delete} onPressOut={this.stopDelete}>   
